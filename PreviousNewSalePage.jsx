              ...
              <div className="p-3 flex-1 flex flex-col border-t-[3px] gap-1.5" style={{ borderTopColor: p.color || '#3b82f6' }}>
                ...
                <div className="flex flex-col mt-auto pt-1 gap-1">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    <span className={`text-[9px] px-1.5 py-0.5 rounded-md font-bold ${p.quantity <= 5 ? 'bg-red-50 text-red-600' : 'bg-gray-100 text-gray-500'}`}>
                      {p.quantity} {p.unit}
                    </span>
                    {p.pieces_per_box > 1 && (
                      <>
                        <span className="text-[9px] text-primary-500 dark:text-primary-400 font-semibold">
    ...
    <>
      ...
      {showAddConfirm && productToConfirm && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-4 sm:p-6 w-full max-w-md shadow-2xl animate-slide-up border border-gray-100 dark:border-gray-800">
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Add to Cart</h3>
            ...
            <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800/50">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 overflow-hidden flex-shrink-0 mt-1">
